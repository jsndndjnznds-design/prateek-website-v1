...
export function StorefrontInfoSection() {
  ...
  return (
    <section className="border-t border-slate-200 bg-slate-50 py-12 dark:border-white/10 dark:bg-slate-900/40 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950 dark:text-white sm:text-3xl">{support.title}</h2>
          <p className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-400">{support.description}</p>
        </div>
